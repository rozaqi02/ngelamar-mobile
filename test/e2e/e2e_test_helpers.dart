...
class E2ETestHelper {
  ...
  static Future<void> setupE2ETestEnvironment() async {
    ...
    final secureStorageData = <String, String>{
      ...
      'ngelamar_secure_user_career_interests':
    ...
    SharedPreferences.setMockInitialValues({
      ...
      'theme_mode': 'light',
      'user_about':
          'Senior Mobile Software Engineer specializing in Flutter & Dart.',
    });
  }
  ...
  static JobApplication createSampleJob({
    ...
    String jobDescription =
        'Membangun fitur mobile kelas dunia dengan Flutter.',
    ...
    return JobApplication(
      id:
          id ??
          'job_${now.millisecondsSinceEpoch}_${1000 + (now.microsecond % 9000)}',
      ...
      benefits:
          benefits ?? ['BPJS Kesehatan', 'Asuransi Swasta', 'Bonus Tahunan'],
  ...
  static List<JobApplication> generateRealisticJobs(int count) {
    ...
    return List.generate(count, (index) {
      ...
      return createSampleJob(
        ...
        maxSalary: maxSal,
        salaryOffered:
            'Rp ${minSal ~/ 1000000}.000.000 - Rp ${maxSal ~/ 1000000}.000.000',
