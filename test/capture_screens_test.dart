...
List<JobApplication> _createSampleJobs() {
  ...
  return [
    JobApplication(
      ...
      jobDescription: 'Mengembangkan aplikasi mobile enterprise menggunakan Flutter & Riverpod. Membangun clean architecture, integrasi REST API & CI/CD.',
      skills: [
      ...
      notes: 'Pelajari arsitektur clean architecture & Riverpod 2.0. Interview bersama Lead Mobile Engineer jam 14:00.',
      isFavorite: true,
    ),
    JobApplication(
      id: 'job-2',
      ...
      jobDescription: 'Merancang pengalaman pengguna untuk produk finansial consumer. Melakukan riset pengguna, prototyping di Figma, dan design system.',
      skills: [
    ...
    JobApplication(
      ...
      sourcePlatform: 'LinkedIn',
      jobDescription: 'Menganalisis kebutuhan pasar dan menyusun roadmap produk travel & lifestyle.',
    ),
    JobApplication(
      id: 'job-6',
      ...
      jobDescription: 'Manual & Automation Testing menggunakan Appium & Selenium.',
    ),
  ];
}
...
Future<void> _captureScreen(
  ...
  await tester.pumpWidget(
    ProviderScope(
      overrides: [
        jobProvider.overrideWith((ref) => notifier),
      ],
      child: MaterialApp(
  ...
  print('CAPTURE_EXPORT:$outputFileName:$encoded');
}
...
void main() {
  ...
  setUpAll(() {
    final tempDir = Directory.systemTemp.createTempSync('ngelamar_screenshot_test_');
  ...
  setUp(() async {
    SharedPreferences.setMockInitialValues({
      ...
      'user_career_interests': ['Mobile Developer', 'UI/UX Designer', 'Software Engineer'],
      'onboarding_done': true,
      'theme_mode': 'light',
      'user_about': 'Mobile Software Engineer dengan spesialisasi Flutter & Dart. Berpengalaman membangun aplikasi Android & iOS dengan performa tinggi, clean architecture, dan state management modern.',
    });
  });
