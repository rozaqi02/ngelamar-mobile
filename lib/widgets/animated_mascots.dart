...
class RunningEnvelopeMascot extends StatefulWidget {
  ...
  const RunningEnvelopeMascot({super.key, this.width = 220, this.height = 160});
...
class _RunningMascotPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      Offset((40 - dustOffset) * scale, 138 * scale),
      6 * scale,
      dustPaint,
    );
    canvas.drawCircle(
      Offset((55 - dustOffset) * scale, 144 * scale),
      4 * scale,
      dustPaint,
    );
    canvas.drawCircle(
      Offset((25 - dustOffset) * scale, 142 * scale),
      3 * scale,
      dustPaint,
    );

    canvas.drawLine(
      Offset(18 * scale, 75 * scale),
      Offset(42 * scale, 75 * scale),
      speedLinePaint,
    );
    canvas.drawLine(
      Offset(10 * scale, 95 * scale),
      Offset(38 * scale, 95 * scale),
      speedLinePaint,
    );
    canvas.drawLine(
      Offset(22 * scale, 115 * scale),
      Offset(46 * scale, 115 * scale),
      speedLinePaint,
    );
    ...
    // Rosy Blush
    canvas.drawOval(
      Rect.fromLTWH(84 * scale, (70 - bobbing) * scale, 10 * scale, 5 * scale),
      blushPaint,
    );
    canvas.drawOval(
      Rect.fromLTWH(126 * scale, (70 - bobbing) * scale, 10 * scale, 5 * scale),
      blushPaint,
    );
    ...
    final leftArm = Path()
      ...
      ..lineTo(
        (38 - leftLegPhase * 10) * scale,
        (62 + leftLegPhase * 8 - bobbing) * scale,
      );
    ...
    final rightArm = Path()
      ...
      ..lineTo(
        (182 + rightLegPhase * 12) * scale,
        (62 - rightLegPhase * 10 - bobbing) * scale,
      );
...
class CryingEnvelopeMascot extends StatefulWidget {
  ...
  const CryingEnvelopeMascot({super.key, this.width = 220, this.height = 160});
...
class _CryingMascotPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawOval(
      Rect.fromCenter(
        center: Offset(110 * scale, 155 * scale),
        width: (50 + sob * 2) * scale,
        height: 12 * scale,
      ),
      puddlePaint,
    );
    ...
    canvas.drawLine(
      Offset(90 * scale, 120 * scale),
      Offset(85 * scale, 148 * scale),
      strokePaint,
    );
    canvas.drawLine(
      Offset(130 * scale, 120 * scale),
      Offset(135 * scale, 148 * scale),
      strokePaint,
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(70 * scale, 144 * scale, 24 * scale, 10 * scale),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(126 * scale, 144 * scale, 24 * scale, 10 * scale),
        Radius.circular(5 * scale),
      ),
      bodyPaint,
    );
    ...
    // Left Tear Stream
    canvas.drawCircle(
      Offset(86 * scale, (76 + sob + tearPhase1 * 50) * scale),
      4 * scale * (1 - tearPhase1 * 0.4),
      tearPaint,
    );
    canvas.drawCircle(
      Offset(88 * scale, (76 + sob + tearPhase2 * 50) * scale),
      3.5 * scale * (1 - tearPhase2 * 0.4),
      tearPaint,
    );

    // Right Tear Stream
    canvas.drawCircle(
      Offset(134 * scale, (76 + sob + tearPhase1 * 50) * scale),
      4 * scale * (1 - tearPhase1 * 0.4),
      tearPaint,
    );
    canvas.drawCircle(
      Offset(132 * scale, (76 + sob + tearPhase2 * 50) * scale),
      3.5 * scale * (1 - tearPhase2 * 0.4),
      tearPaint,
    );
...
class _ProKingMascotPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawPlus(Offset center, double s, Color color, double pulsePhase) {
      final pulse =
          1.0 + 0.25 * math.sin((progress + pulsePhase) * 2 * math.pi);
      final pPaint = Paint()
        ..color = color
        ..style = PaintingStyle.stroke
    ...
    drawPlus(
      Offset(28 * scale, (35 + floatOffset * 0.5) * scale),
      9,
      const Color(0xFFF59E0B),
      0.0,
    );
    drawPlus(
      Offset(50 * scale, (18 - floatOffset * 0.4) * scale),
      5,
      const Color(0xFF5C44E4),
      0.25,
    );
    drawPlus(
      Offset(212 * scale, (32 - floatOffset * 0.5) * scale),
      10,
      const Color(0xFFF59E0B),
      0.5,
    );
    drawPlus(
      Offset(188 * scale, (18 + floatOffset * 0.3) * scale),
      6,
      const Color(0xFF1E8E3E),
      0.75,
    );
    drawPlus(
      Offset(22 * scale, (130 - floatOffset * 0.3) * scale),
      7,
      const Color(0xFF5C44E4),
      0.33,
    );
    drawPlus(
      Offset(218 * scale, (125 + floatOffset * 0.4) * scale),
      8,
      const Color(0xFFF59E0B),
      0.66,
    );
    ...
    // ── LEGS ──
    canvas.drawLine(
      Offset(85 * scale, 125 * scale),
      Offset(75 * scale, 155 * scale),
      strokePaint,
    );
    canvas.drawLine(
      Offset(155 * scale, 125 * scale),
      Offset(165 * scale, 155 * scale),
      strokePaint,
    );
    ...
    final gleamPaint = Paint()
      ..color = Colors.white.withValues(alpha: gleamAlpha);
    canvas.drawCircle(
      Offset(120 * scale, (14 + floatOffset) * scale),
      3.5 * scale,
      gleamPaint,
    );
    ...
    final leftEye = Path()
      ...
      ..quadraticBezierTo(
        98 * scale,
        (68 + floatOffset) * scale,
        104 * scale,
        (76 + floatOffset) * scale,
      );
    canvas.drawPath(leftEye, strokePaint);
    ...
    final smile = Path()
      ...
      ..quadraticBezierTo(
        120 * scale,
        (92 + floatOffset) * scale,
        128 * scale,
        (82 + floatOffset) * scale,
      );
    ...
    final leftArm = Path()
      ...
      ..cubicTo(
        32 * scale,
        (75 + floatOffset) * scale,
        25 * scale,
        (55 + floatOffset) * scale,
        35 * scale,
        (42 + floatOffset) * scale,
      );
    canvas.drawPath(leftArm, strokePaint);
    canvas.drawCircle(
      Offset(35 * scale, (42 + floatOffset) * scale),
      9 * scale,
      bodyPaint,
    );
    canvas.drawCircle(
    ...
    canvas.drawPath(rightArm, strokePaint);
    canvas.drawCircle(
      Offset(205 * scale, (42 + floatOffset) * scale),
      9 * scale,
      bodyPaint,
    );
    canvas.drawCircle(
...
class _DiscoveryExplorerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Legs
    canvas.drawLine(
      Offset(85 * scale, 120 * scale),
      Offset(78 * scale, 148 * scale),
      strokePaint,
    );
    canvas.drawLine(
      Offset(135 * scale, 120 * scale),
      Offset(142 * scale, 148 * scale),
      strokePaint,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(64 * scale, 144 * scale, 24 * scale, 10 * scale),
        Radius.circular(5 * scale),
      ),
      bodyPaint,
    );
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(132 * scale, 144 * scale, 24 * scale, 10 * scale),
        Radius.circular(5 * scale),
      ),
      bodyPaint,
    );
    ...
    // Body
    final envRect = RRect.fromRectAndRadius(
      Rect.fromLTWH(55 * scale, 45 * scale, 110 * scale, 75 * scale),
      Radius.circular(16 * scale),
    );
    canvas.drawRRect(envRect, bodyPaint);
    canvas.drawRRect(envRect, strokePaint);
    ...
    // Flap
    final flapTop = Path()
      ..moveTo(57 * scale, 47 * scale)
      ..lineTo(110 * scale, 85 * scale)
      ..lineTo(163 * scale, 47 * scale);
    canvas.drawPath(flapTop, strokePaint);

    // Wide curious eyes
    canvas.drawCircle(
      Offset(88 * scale, 72 * scale),
      7 * scale,
      Paint()..color = const Color(0xFF121214),
    );
    canvas.drawCircle(
      Offset(90 * scale, 70 * scale),
      2.5 * scale,
      Paint()..color = Colors.white,
    );
    canvas.drawCircle(
      Offset(132 * scale, 72 * scale),
      7 * scale,
      Paint()..color = const Color(0xFF121214),
    );
    canvas.drawCircle(
      Offset(134 * scale, 70 * scale),
      2.5 * scale,
      Paint()..color = Colors.white,
    );
    ...
    // Smile
    final smile = Path()
      ..moveTo(104 * scale, 82 * scale)
      ..quadraticBezierTo(110 * scale, 90 * scale, 116 * scale, 82 * scale);
    canvas.drawPath(smile, strokePaint);
    ...
    canvas.drawCircle(
      glassCenter,
      20 * scale,
      cyanFill..color = const Color(0xFF00C7BE).withValues(alpha: 0.3),
    );
    canvas.drawCircle(glassCenter, 20 * scale, strokePaint);
    canvas.drawLine(
      Offset(glassCenter.dx - 14 * scale, glassCenter.dy + 14 * scale),
      Offset(glassCenter.dx - 26 * scale, glassCenter.dy + 26 * scale),
      strokePaint..strokeWidth = 5 * scale,
    );
...
class _TrackerClipboardPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Body
    final envRect = RRect.fromRectAndRadius(
      Rect.fromLTWH(55 * scale, (45 + tapBob) * scale, 110 * scale, 75 * scale),
      Radius.circular(16 * scale),
    );
    canvas.drawRRect(envRect, bodyPaint);
    canvas.drawRRect(envRect, strokePaint);
    ...
    // Flap
    final flapTop = Path()
      ..moveTo(57 * scale, (47 + tapBob) * scale)
      ..lineTo(110 * scale, (85 + tapBob) * scale)
      ..lineTo(163 * scale, (47 + tapBob) * scale);
    canvas.drawPath(flapTop, strokePaint);

    // Cheerful Eyes ^ ^
    final leftEye = Path()
      ..moveTo(82 * scale, (72 + tapBob) * scale)
      ..quadraticBezierTo(
        88 * scale,
        (64 + tapBob) * scale,
        94 * scale,
    ...
    final rightEye = Path()
      ..moveTo(126 * scale, (72 + tapBob) * scale)
      ..quadraticBezierTo(
        132 * scale,
        (64 + tapBob) * scale,
        138 * scale,
    ...
    // Smile
    final smile = Path()
      ..moveTo(104 * scale, (82 + tapBob) * scale)
      ..quadraticBezierTo(
        110 * scale,
        (90 + tapBob) * scale,
        116 * scale,
    ...
    final clipRect = RRect.fromRectAndRadius(
      Rect.fromLTWH(150 * scale, (40 + tapBob) * scale, 45 * scale, 60 * scale),
    ...
    canvas.drawCircle(
      Offset(160 * scale, (52 + tapBob) * scale),
      4 * scale,
      greenFill,
    );
    canvas.drawLine(
      Offset(168 * scale, (52 + tapBob) * scale),
      Offset(186 * scale, (52 + tapBob) * scale),
      strokePaint..strokeWidth = 2 * scale,
    );

    canvas.drawCircle(
      Offset(160 * scale, (65 + tapBob) * scale),
      4 * scale,
      greenFill,
    );
    canvas.drawLine(
      Offset(168 * scale, (65 + tapBob) * scale),
      Offset(186 * scale, (65 + tapBob) * scale),
      strokePaint..strokeWidth = 2 * scale,
    );
    ...
    if (check3Pulse) {
      canvas.drawCircle(
        Offset(160 * scale, (78 + tapBob) * scale),
        4 * scale,
        greenFill,
      );
    }
    canvas.drawLine(
      Offset(168 * scale, (78 + tapBob) * scale),
      Offset(186 * scale, (78 + tapBob) * scale),
      strokePaint..strokeWidth = 2 * scale,
    );
  }
...
class ScholarPrepMascot extends StatefulWidget {
  ...
  const ScholarPrepMascot({super.key, this.width = 220, this.height = 160});
...
class _ScholarPrepPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final togaBlack = Paint()
      ..color = const Color(0xFF19191B)
      ..style = PaintingStyle.fill;
    final goldTassel = Paint()
      ..color = const Color(0xFFF59E0B)
      ..style = PaintingStyle.fill;
    ...
    // Flap
    final flapTop = Path()
      ..moveTo(57 * scale, (47 + floatBob) * scale)
      ..lineTo(110 * scale, (85 + floatBob) * scale)
      ..lineTo(163 * scale, (47 + floatBob) * scale);
    canvas.drawPath(flapTop, strokePaint);
    ...
    canvas.drawCircle(
      Offset((148 * scale) + tasselSway, (50 + floatBob) * scale),
      3.5 * scale,
      goldTassel,
    );
    ...
    canvas.drawCircle(
      Offset(88 * scale, (72 + floatBob) * scale),
      10 * scale,
      bodyPaint,
    );
    canvas.drawCircle(
    ...
    canvas.drawCircle(
      Offset(132 * scale, (72 + floatBob) * scale),
      10 * scale,
      bodyPaint,
    );
    canvas.drawCircle(
    ...
    canvas.drawLine(
      Offset(98 * scale, (72 + floatBob) * scale),
      Offset(122 * scale, (72 + floatBob) * scale),
      strokePaint,
    );

    // Smile
    final smile = Path()
      ..moveTo(104 * scale, (84 + floatBob) * scale)
      ..quadraticBezierTo(
        110 * scale,
        (92 + floatBob) * scale,
        116 * scale,
